...
import { ContentStyleVII } from './style';
...
const Content7 = () => {
    ...
    return (
        <ContentStyleVII className="boxbox" ref={wrap}>
            <div className="content_pic" ref={PicRef}>
                <img src="./images/content5_img3.png" alt="" />
            </div>
            <div className="inner">
                <h2 className="title" ref={TitleRef}>{`VISIONARY
                LOCATION`}</h2>
                <h2 className="title" ref={TitleRef2}>{`VISINARY
                LOCATION`}</h2>

                <div className="textItem" ref={TextRef}>
                    <strong>{`대한민국을 이끄는 비전의 
                    중심에 자리하다
           `}</strong>
                    <span>
                        오시는길
